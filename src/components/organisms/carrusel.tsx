...
const Carrusel = () => {
    ...
    useEffect(() => {
        const intervalo = setInterval(() => {setIndice((prevIndice) => (prevIndice + 1) % peliculas.length);}, 10000); // cambia cada 10 segundos
        return () => clearInterval(intervalo); // limpiar el intervalo
    }, []);
        ...
        <div id="carouselExampleDark" className={`carousel slide ${styles.carousel}`} data-bs-ride="carousel" >
            ...
            <div className="carousel-inner">
                {peliculas.map((pelicula, i) => (
                    <div key={i} className={`carousel-item ${i === indice ? "active" : ""}`} data-bs-ride="carousel" data-bs-interval="3000">
